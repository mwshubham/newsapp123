...
class HomeAdapter(val context: Context, val articles:List<Article>):
    RecyclerView.Adapter<HomeAdapter.ArticleViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ArticleViewHolder {
        val view=LayoutInflater.from(context).inflate(R.layout.fragmenthome_adapter,parent,false)
